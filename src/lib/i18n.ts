...
function setupI18n() {
  dictionary.set({
    ...
    fr: {
      ...
      'home.training.description': 'Enseignant à l\'Université, j\'exerce aussi en tant que formateur professionnel enregistré.',
      ...
      'home.training.subtitle': 'Une expérience réelle, issues d\'une pratique de plus de 15 ans en tant qu\'Architecte, autour de la cyber-sécurité et dans l\'enseignement supérieur.',
